...
class NormalizeLimitTests(unittest.TestCase):
    def setUp(self) -> None:
        self.provider_patch = patch.object(settings, "NORMALIZATION_LLM_PROVIDER", "ollama")
        self.model_patch = patch.object(settings, "NORMALIZATION_LLM_MODEL", "exaone3.5")
    ...
    def test_or_sales_condition_is_not_flattened(self, mock_post) -> None:
        ...
        self.assertEqual(result["extraction_method"], "llm_structure")
